namespace ZTR.M7Config.Business.Parsers.Core.Converter
{
    ...
    public class ConvertConfig
    {
        ...
        internal static string VisibleKey => "isvisible";
        internal static string Fields => "fields";
        internal static string Arrays => "arrays";
        ...
        private static string Path => $"{Global.WebRoot}/{_skipConfigFolder}/convert.config";
        private static string HTMLPath => $"{Global.WebRoot}/{_skipConfigFolder}/config.html";
        private static string MapperPath => $"{Global.WebRoot}/{_skipConfigFolder}/map.config";
        ...
        internal static IEnumerable<ConfigMap> GetMapping()
        {
        ...
        internal static async Task<bool> UpdateConfiguration(string properties)
        {
