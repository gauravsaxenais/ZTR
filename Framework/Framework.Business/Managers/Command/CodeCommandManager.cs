namespace ZTR.Framework.Business
{
    ...
    public abstract class CodeCommandManager<TDbContext, TErrorCode, TEntity, TCreateModel, TUpdateModel>
        : CommandManager<TDbContext, TErrorCode, TEntity, TCreateModel, TUpdateModel>, ICodeCommandManager<TErrorCode, TCreateModel, TUpdateModel>
    ...
    {
        protected CodeCommandManager(TDbContext databaseContext, ModelValidator<TCreateModel> createModelValidator, ModelValidator<TUpdateModel> updateModelValidator, ILogger<CodeCommandManager<TDbContext, TErrorCode, TEntity, TCreateModel, TUpdateModel>> logger, IMapper mapper, TErrorCode idDoesNotExist, TErrorCode idNotUnique, TErrorCode codeNotUnique)
